 ...
 *  @author Kevin Wayne
 */
public final class StdDrawEx2 implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static StdDrawEx2 std = new StdDrawEx2();
    ...
    private static void init() {
        ...
        ////////////////
        JLabel jtf = new JLabel("Insert Text");
        draw.add(jtf);
    ...
    public static void save(String filename) {
        Ex2GUI.save(filename);
    }
    public static void load(String filename) {
        Ex2GUI.load(filename);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(m.equals("Save")) {
            FileDialog chooser = new FileDialog(StdDrawEx2.frame, "Save: choos file name to be saved ", FileDialog.SAVE);
        ...
        if(m.equals("Load")) {
            FileDialog chooser = new FileDialog(StdDrawEx2.frame, "Load: choose a file to be loaded", FileDialog.LOAD);
            chooser.setVisible(true);
            String filename = chooser.getFile();
            if (filename != null) {
                String f = chooser.getDirectory() + chooser.getFile();
    ...
    public static int getXX() {return xx;}
    public static int getYY() {return yy;}
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        double y = Ex2Utils.HEIGHT-my;
        double x = (mx-2)/2;
        xx = (int)x;
        yy=(int)y;
        if(Ex2Utils.Debug) {System.out.println("Mouse: "+xx+","+yy);}
    ...
    public void mousePressed(MouseEvent e) {
        synchronized (mouseLock) {
            mouseX = StdDrawEx2.userX(e.getX());
            mouseY = StdDrawEx2.userY(e.getY());
            isMousePressed = true;
        }
    }
     ...
     */
    public static void main(String[] args) {
        StdDrawEx2.square(0.2, 0.8, 0.1);
        StdDrawEx2.filledSquare(0.8, 0.8, 0.2);
        StdDrawEx2.circle(0.8, 0.2, 0.2);

        StdDrawEx2.setPenColor(StdDrawEx2.BOOK_RED);
        StdDrawEx2.setPenRadius(0.02);
        StdDrawEx2.arc(0.8, 0.2, 0.1, 200, 45);

        // draw a blue diamond
        StdDrawEx2.setPenRadius();
        StdDrawEx2.setPenColor(StdDrawEx2.BOOK_BLUE);
        double[] x = { 0.1, 0.2, 0.3, 0.2 };
        double[] y = { 0.2, 0.3, 0.2, 0.1 };
        StdDrawEx2.filledPolygon(x, y);
        ...
        StdDrawEx2.text(0.2, 0.5, "black text");
        StdDrawEx2.setPenColor(StdDrawEx2.WHITE);
        StdDrawEx2.text(0.8, 0.8, "white text");
    }
